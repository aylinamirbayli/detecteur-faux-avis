...
Bien que ces exemples extrêmes (0.23 et 0.85) donnent le même résultat avec les deux seuils, l'impact réel se manifeste sur les avis avec probabilités intermédiaires (entre 0.5 et 0.65). C'est dans cette zone que le seuil 0.65 protège efficacement les avis authentiques des faux positifs.
